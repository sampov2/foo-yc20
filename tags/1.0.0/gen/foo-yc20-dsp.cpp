...
//
// Code generated with Faust 0.9.21 (http://faust.grame.fr)
//-----------------------------------------------------
/* link with : "" */
  ...
  public:
	...
	virtual void compute (int count, FAUSTFLOAT** input, FAUSTFLOAT** output) {
		...
		for (int i=0; i<count; i++) {
			...
			fRec7[0] = ((fRec7[1] + fSlow6) - floorf(fRec7[1]));
			float fTemp1 = ((fSlow7 * sinf((6.283185307179586f * fRec7[0]))) + fSlow5);
			float fTemp2 = ((fConst1 * float((6271.926975707989f * (fTemp1 * fSlow4)))) + fRec6[1]);
			...
			fVec6[0] = fSlow8;
			float fTemp22 = (fSlow8 + (fVec6[3] + (fVec6[1] + fVec6[2])));
			float fTemp23 = ((fConst1 * float((6644.875161279122f * (fTemp1 * fSlow9)))) + fRec17[1]);
			...
			fVec12[0] = fSlow10;
			float fTemp43 = (fSlow10 + (fVec12[3] + (fVec12[1] + fVec12[2])));
			float fTemp44 = ((fConst1 * float((7.04e+03f * (fTemp1 * fSlow11)))) + fRec27[1]);
			...
			fVec18[0] = fSlow12;
			float fTemp64 = (fSlow12 + (fVec18[3] + (fVec18[1] + fVec18[2])));
			float fTemp65 = ((fConst1 * float((7458.620184289437f * (fTemp1 * fSlow13)))) + fRec37[1]);
			...
			fVec24[0] = fSlow14;
			float fTemp85 = (fSlow14 + (fVec24[3] + (fVec24[1] + fVec24[2])));
			float fTemp86 = ((fConst1 * float((7902.132820097988f * (fTemp1 * fSlow15)))) + fRec47[1]);
			...
			fVec30[0] = fSlow16;
			float fTemp106 = (fSlow16 + (fVec30[3] + (fVec30[1] + fVec30[2])));
			float fTemp107 = ((fConst1 * float((4186.009044809578f * (fTemp1 * fSlow17)))) + fRec57[1]);
			...
			fVec35[0] = fSlow18;
			float fTemp124 = (fSlow18 + (fVec35[3] + (fVec35[1] + fVec35[2])));
			float fTemp125 = ((fConst1 * float((4434.922095629953f * (fTemp1 * fSlow19)))) + fRec66[1]);
			...
			fVec40[0] = fSlow20;
			float fTemp142 = (fSlow20 + (fVec40[3] + (fVec40[1] + fVec40[2])));
			float fTemp143 = ((fConst1 * float((4698.63628667852f * (fTemp1 * fSlow21)))) + fRec75[1]);
			...
			fVec45[0] = fSlow22;
			float fTemp160 = (fSlow22 + (fVec45[3] + (fVec45[1] + fVec45[2])));
			float fTemp161 = ((fConst1 * float((4978.031739553295f * (fTemp1 * fSlow23)))) + fRec84[1]);
			...
			fVec50[0] = fSlow24;
			float fTemp178 = (fSlow24 + (fVec50[3] + (fVec50[1] + fVec50[2])));
			...
			fVec55[0] = fSlow26;
			float fTemp196 = (fSlow26 + (fVec55[3] + (fVec55[1] + fVec55[2])));
			float fTemp197 = ((fConst1 * float((5587.651702928062f * (fTemp1 * fSlow27)))) + fRec102[1]);
			...
			fVec60[0] = fSlow28;
			float fTemp214 = (fSlow28 + (fVec60[3] + (fVec60[1] + fVec60[2])));
			float fTemp215 = ((fConst1 * float((5919.91076338615f * (fTemp1 * fSlow29)))) + fRec111[1]);
			...
			fVec65[0] = fSlow30;
			float fTemp232 = (fSlow30 + (fVec65[3] + (fVec65[1] + fVec65[2])));
			...
			fVec66[0] = fSlow31;
			float fTemp237 = (fSlow31 + (fVec66[3] + (fVec66[1] + fVec66[2])));
			...
			fVec67[0] = fSlow32;
			float fTemp242 = (fSlow32 + (fVec67[3] + (fVec67[1] + fVec67[2])));
			...
			fVec68[0] = fSlow33;
			float fTemp247 = (fSlow33 + (fVec68[3] + (fVec68[1] + fVec68[2])));
			...
			fVec69[0] = fSlow34;
			float fTemp252 = (fSlow34 + (fVec69[3] + (fVec69[1] + fVec69[2])));
			...
			fVec70[0] = fSlow37;
			float fTemp257 = (fSlow37 + (fVec70[3] + (fVec70[1] + fVec70[2])));
			...
			fVec71[0] = fSlow38;
			float fTemp262 = (fSlow38 + (fVec71[3] + (fVec71[1] + fVec71[2])));
			...
			fVec72[0] = fSlow39;
			float fTemp267 = (fSlow39 + (fVec72[3] + (fVec72[1] + fVec72[2])));
			...
			fVec73[0] = fSlow40;
			float fTemp272 = (fSlow40 + (fVec73[3] + (fVec73[1] + fVec73[2])));
			...
			fVec74[0] = fSlow41;
			float fTemp277 = (fSlow41 + (fVec74[3] + (fVec74[1] + fVec74[2])));
			...
			fVec75[0] = fSlow42;
			float fTemp282 = (fSlow42 + (fVec75[3] + (fVec75[1] + fVec75[2])));
			...
			fVec76[0] = fSlow43;
			float fTemp287 = (fSlow43 + (fVec76[3] + (fVec76[1] + fVec76[2])));
			...
			fVec77[0] = fSlow44;
			float fTemp292 = (fSlow44 + (fVec77[3] + (fVec77[1] + fVec77[2])));
			...
			fVec78[0] = fSlow45;
			float fTemp297 = (fSlow45 + (fVec78[3] + (fVec78[1] + fVec78[2])));
			...
			fVec79[0] = fSlow46;
			float fTemp302 = (fSlow46 + (fVec79[3] + (fVec79[1] + fVec79[2])));
			...
			fVec80[0] = fSlow47;
			float fTemp307 = (fSlow47 + (fVec80[3] + (fVec80[1] + fVec80[2])));
			...
			fVec81[0] = fSlow48;
			float fTemp312 = (fSlow48 + (fVec81[3] + (fVec81[1] + fVec81[2])));
			...
			fVec82[0] = fSlow49;
			float fTemp317 = (fSlow49 + (fVec82[3] + (fVec82[1] + fVec82[2])));
			...
			fVec83[0] = fSlow50;
			float fTemp322 = (fSlow50 + (fVec83[3] + (fVec83[1] + fVec83[2])));
			...
			fVec84[0] = fSlow51;
			float fTemp327 = (fSlow51 + (fVec84[3] + (fVec84[1] + fVec84[2])));
			...
			fVec85[0] = fSlow52;
			float fTemp332 = (fSlow52 + (fVec85[3] + (fVec85[1] + fVec85[2])));
			...
			fVec86[0] = fSlow53;
			float fTemp337 = (fSlow53 + (fVec86[3] + (fVec86[1] + fVec86[2])));
			...
			fVec87[0] = fSlow54;
			float fTemp342 = (fSlow54 + (fVec87[3] + (fVec87[1] + fVec87[2])));
			...
			fVec88[0] = fSlow55;
			float fTemp347 = (fSlow55 + (fVec88[3] + (fVec88[1] + fVec88[2])));
			...
			fVec89[0] = fSlow56;
			float fTemp352 = (fSlow56 + (fVec89[3] + (fVec89[1] + fVec89[2])));
			...
			fVec90[0] = fSlow57;
			float fTemp357 = (fSlow57 + (fVec90[3] + (fVec90[1] + fVec90[2])));
			...
			fVec91[0] = fSlow58;
			float fTemp362 = (fSlow58 + (fVec91[3] + (fVec91[1] + fVec91[2])));
			...
			fVec92[0] = fSlow59;
			float fTemp367 = (fSlow59 + (fVec92[3] + (fVec92[1] + fVec92[2])));
			...
			fVec93[0] = fSlow60;
			float fTemp372 = (fSlow60 + (fVec93[3] + (fVec93[1] + fVec93[2])));
			...
			fVec94[0] = fSlow61;
			float fTemp377 = (fSlow61 + (fVec94[3] + (fVec94[1] + fVec94[2])));
			...
			fVec95[0] = fSlow62;
			float fTemp382 = (fSlow62 + (fVec95[3] + (fVec95[1] + fVec95[2])));
			...
			fVec96[0] = fSlow63;
			float fTemp387 = (fSlow63 + (fVec96[3] + (fVec96[1] + fVec96[2])));
			...
			fVec97[0] = fSlow64;
			float fTemp392 = (fSlow64 + (fVec97[3] + (fVec97[1] + fVec97[2])));
			...
			fVec98[0] = fSlow65;
			float fTemp397 = (fSlow65 + (fVec98[3] + (fVec98[1] + fVec98[2])));
			...
			fVec99[0] = fSlow66;
			float fTemp402 = (fSlow66 + (fVec99[3] + (fVec99[1] + fVec99[2])));
			...
			fVec100[0] = fSlow67;
			float fTemp407 = (fSlow67 + (fVec100[3] + (fVec100[1] + fVec100[2])));
			...
			fVec101[0] = fSlow68;
			float fTemp412 = (fSlow68 + (fVec101[3] + (fVec101[1] + fVec101[2])));
			...
			fVec102[0] = fSlow69;
			float fTemp417 = (fSlow69 + (fVec102[3] + (fVec102[1] + fVec102[2])));
			...
			fVec103[0] = fSlow70;
			float fTemp422 = (fSlow70 + (fVec103[3] + (fVec103[1] + fVec103[2])));
			...
			fVec104[0] = fSlow71;
			float fTemp427 = (fSlow71 + (fVec104[3] + (fVec104[1] + fVec104[2])));
			...
			fVec105[0] = fSlow72;
			float fTemp432 = (fSlow72 + (fVec105[3] + (fVec105[1] + fVec105[2])));
			...
			fVec106[0] = fSlow73;
			float fTemp437 = (fSlow73 + (fVec106[3] + (fVec106[1] + fVec106[2])));
			...
			fVec107[0] = fSlow74;
			float fTemp441 = (fSlow74 + (fVec107[3] + (fVec107[1] + fVec107[2])));
			...
			fVec108[0] = fSlow75;
			float fTemp445 = (fSlow75 + (fVec108[3] + (fVec108[1] + fVec108[2])));
			...
			fVec109[0] = fSlow76;
			float fTemp449 = (fSlow76 + (fVec109[3] + (fVec109[1] + fVec109[2])));
			...
			fVec110[0] = fSlow77;
			float fTemp453 = (fSlow77 + (fVec110[3] + (fVec110[1] + fVec110[2])));
			...
			fVec111[0] = fSlow78;
			float fTemp457 = (fSlow78 + (fVec111[3] + (fVec111[1] + fVec111[2])));
			...
			fVec112[0] = fSlow79;
			float fTemp461 = (fSlow79 + (fVec112[3] + (fVec112[1] + fVec112[2])));
			...
			fVec113[0] = fSlow80;
			float fTemp465 = (fSlow80 + (fVec113[3] + (fVec113[1] + fVec113[2])));
			...
			fVec116[0] = fTemp536;
			float fTemp537 = (0.5f * fVec116[0]);
			float fTemp538 = (0.5f * fVec116[1]);
			iRec322[0] = ((int(((fTemp537 - fTemp538) < 0)))?(1 - iRec322[1]):iRec322[1]);
			float fTemp539 = (iRec322[0] + fTemp537);
			fVec117[0] = fTemp539;
			float fTemp540 = (0.5f * fVec117[0]);
			float fTemp541 = (0.5f * fVec117[1]);
			iRec323[0] = ((int(((fTemp540 - fTemp541) < 0)))?(1 - iRec323[1]):iRec323[1]);
			float fTemp542 = (iRec323[0] + fTemp540);
			fVec118[0] = fTemp542;
			float fTemp543 = (0.5f * fVec118[1]);
			float fTemp544 = (0.5f * fVec118[0]);
			float fTemp545 = (1 + fTemp544);
			float fTemp546 = (fTemp545 - (fTemp543 + floorf((fTemp545 - fTemp543))));
			float fTemp547 = (0.5f * (1.0f + fVec118[0]));
			int iTemp548 = ((int((fTemp543 > fTemp544)))?1:((int(((fTemp547 - floorf(fTemp547)) < fTemp546)))?2:0));
			fRec319[0] = square_blep_x(iTemp548, ((int((fTemp544 < 0.5f)))?1.0f:-1.0f), fTemp544, fTemp546);
			float 	fRec320 = square_blep_prev(iTemp548, fRec319[1], fTemp543, fTemp546);
			...
			float fTemp549 = (iRec328[0] + fTemp137);
			fVec119[0] = fTemp549;
			float fTemp550 = (0.5f * fVec119[0]);
			float fTemp551 = (0.5f * fVec119[1]);
			iRec329[0] = ((int(((fTemp550 - fTemp551) < 0)))?(1 - iRec329[1]):iRec329[1]);
			float fTemp552 = (iRec329[0] + fTemp550);
			fVec120[0] = fTemp552;
			float fTemp553 = (0.5f * fVec120[0]);
			float fTemp554 = (0.5f * fVec120[1]);
			iRec330[0] = ((int(((fTemp553 - fTemp554) < 0)))?(1 - iRec330[1]):iRec330[1]);
			float fTemp555 = (iRec330[0] + fTemp553);
			fVec121[0] = fTemp555;
			float fTemp556 = (0.5f * fVec121[1]);
			float fTemp557 = (0.5f * fVec121[0]);
			float fTemp558 = (1 + fTemp557);
			float fTemp559 = (fTemp558 - (fTemp556 + floorf((fTemp558 - fTemp556))));
			float fTemp560 = (0.5f * (1.0f + fVec121[0]));
			int iTemp561 = ((int((fTemp556 > fTemp557)))?1:((int(((fTemp560 - floorf(fTemp560)) < fTemp559)))?2:0));
			fRec326[0] = square_blep_x(iTemp561, ((int((fTemp557 < 0.5f)))?1.0f:-1.0f), fTemp557, fTemp559);
			float 	fRec327 = square_blep_prev(iTemp561, fRec326[1], fTemp556, fTemp559);
			...
			float fTemp562 = (iRec335[0] + fTemp155);
			fVec122[0] = fTemp562;
			float fTemp563 = (0.5f * fVec122[0]);
			float fTemp564 = (0.5f * fVec122[1]);
			iRec336[0] = ((int(((fTemp563 - fTemp564) < 0)))?(1 - iRec336[1]):iRec336[1]);
			float fTemp565 = (iRec336[0] + fTemp563);
			fVec123[0] = fTemp565;
			float fTemp566 = (0.5f * fVec123[0]);
			float fTemp567 = (0.5f * fVec123[1]);
			iRec337[0] = ((int(((fTemp566 - fTemp567) < 0)))?(1 - iRec337[1]):iRec337[1]);
			float fTemp568 = (iRec337[0] + fTemp566);
			fVec124[0] = fTemp568;
			float fTemp569 = (0.5f * fVec124[1]);
			float fTemp570 = (0.5f * fVec124[0]);
			float fTemp571 = (1 + fTemp570);
			float fTemp572 = (fTemp571 - (fTemp569 + floorf((fTemp571 - fTemp569))));
			float fTemp573 = (0.5f * (1.0f + fVec124[0]));
			int iTemp574 = ((int((fTemp569 > fTemp570)))?1:((int(((fTemp573 - floorf(fTemp573)) < fTemp572)))?2:0));
			fRec333[0] = square_blep_x(iTemp574, ((int((fTemp570 < 0.5f)))?1.0f:-1.0f), fTemp570, fTemp572);
			float 	fRec334 = square_blep_prev(iTemp574, fRec333[1], fTemp569, fTemp572);
			...
			float fTemp575 = (iRec342[0] + fTemp173);
			fVec125[0] = fTemp575;
			float fTemp576 = (0.5f * fVec125[0]);
			float fTemp577 = (0.5f * fVec125[1]);
			iRec343[0] = ((int(((fTemp576 - fTemp577) < 0)))?(1 - iRec343[1]):iRec343[1]);
			float fTemp578 = (iRec343[0] + fTemp576);
			fVec126[0] = fTemp578;
			float fTemp579 = (0.5f * fVec126[0]);
			float fTemp580 = (0.5f * fVec126[1]);
			iRec344[0] = ((int(((fTemp579 - fTemp580) < 0)))?(1 - iRec344[1]):iRec344[1]);
			float fTemp581 = (iRec344[0] + fTemp579);
			fVec127[0] = fTemp581;
			float fTemp582 = (0.5f * fVec127[1]);
			float fTemp583 = (0.5f * fVec127[0]);
			float fTemp584 = (1 + fTemp583);
			float fTemp585 = (fTemp584 - (fTemp582 + floorf((fTemp584 - fTemp582))));
			float fTemp586 = (0.5f * (1.0f + fVec127[0]));
			int iTemp587 = ((int((fTemp582 > fTemp583)))?1:((int(((fTemp586 - floorf(fTemp586)) < fTemp585)))?2:0));
			fRec340[0] = square_blep_x(iTemp587, ((int((fTemp583 < 0.5f)))?1.0f:-1.0f), fTemp583, fTemp585);
			float 	fRec341 = square_blep_prev(iTemp587, fRec340[1], fTemp582, fTemp585);
			...
			float fTemp588 = (iRec349[0] + fTemp191);
			fVec128[0] = fTemp588;
			float fTemp589 = (0.5f * fVec128[0]);
			float fTemp590 = (0.5f * fVec128[1]);
			iRec350[0] = ((int(((fTemp589 - fTemp590) < 0)))?(1 - iRec350[1]):iRec350[1]);
			float fTemp591 = (iRec350[0] + fTemp589);
			fVec129[0] = fTemp591;
			float fTemp592 = (0.5f * fVec129[0]);
			float fTemp593 = (0.5f * fVec129[1]);
			iRec351[0] = ((int(((fTemp592 - fTemp593) < 0)))?(1 - iRec351[1]):iRec351[1]);
			float fTemp594 = (iRec351[0] + fTemp592);
			fVec130[0] = fTemp594;
			float fTemp595 = (0.5f * fVec130[1]);
			float fTemp596 = (0.5f * fVec130[0]);
			float fTemp597 = (1 + fTemp596);
			float fTemp598 = (fTemp597 - (fTemp595 + floorf((fTemp597 - fTemp595))));
			float fTemp599 = (0.5f * (1.0f + fVec130[0]));
			int iTemp600 = ((int((fTemp595 > fTemp596)))?1:((int(((fTemp599 - floorf(fTemp599)) < fTemp598)))?2:0));
			fRec347[0] = square_blep_x(iTemp600, ((int((fTemp596 < 0.5f)))?1.0f:-1.0f), fTemp596, fTemp598);
			float 	fRec348 = square_blep_prev(iTemp600, fRec347[1], fTemp595, fTemp598);
			...
			float fTemp601 = (iRec356[0] + fTemp209);
			fVec131[0] = fTemp601;
			float fTemp602 = (0.5f * fVec131[0]);
			float fTemp603 = (0.5f * fVec131[1]);
			iRec357[0] = ((int(((fTemp602 - fTemp603) < 0)))?(1 - iRec357[1]):iRec357[1]);
			float fTemp604 = (iRec357[0] + fTemp602);
			fVec132[0] = fTemp604;
			float fTemp605 = (0.5f * fVec132[0]);
			float fTemp606 = (0.5f * fVec132[1]);
			iRec358[0] = ((int(((fTemp605 - fTemp606) < 0)))?(1 - iRec358[1]):iRec358[1]);
			float fTemp607 = (iRec358[0] + fTemp605);
			fVec133[0] = fTemp607;
			float fTemp608 = (0.5f * fVec133[1]);
			float fTemp609 = (0.5f * fVec133[0]);
			float fTemp610 = (1 + fTemp609);
			float fTemp611 = (fTemp610 - (fTemp608 + floorf((fTemp610 - fTemp608))));
			float fTemp612 = (0.5f * (1.0f + fVec133[0]));
			int iTemp613 = ((int((fTemp608 > fTemp609)))?1:((int(((fTemp612 - floorf(fTemp612)) < fTemp611)))?2:0));
			fRec354[0] = square_blep_x(iTemp613, ((int((fTemp609 < 0.5f)))?1.0f:-1.0f), fTemp609, fTemp611);
			float 	fRec355 = square_blep_prev(iTemp613, fRec354[1], fTemp608, fTemp611);
			...
			float fTemp614 = (iRec363[0] + fTemp227);
			fVec134[0] = fTemp614;
			float fTemp615 = (0.5f * fVec134[0]);
			float fTemp616 = (0.5f * fVec134[1]);
			iRec364[0] = ((int(((fTemp615 - fTemp616) < 0)))?(1 - iRec364[1]):iRec364[1]);
			float fTemp617 = (iRec364[0] + fTemp615);
			fVec135[0] = fTemp617;
			float fTemp618 = (0.5f * fVec135[0]);
			float fTemp619 = (0.5f * fVec135[1]);
			iRec365[0] = ((int(((fTemp618 - fTemp619) < 0)))?(1 - iRec365[1]):iRec365[1]);
			float fTemp620 = (iRec365[0] + fTemp618);
			fVec136[0] = fTemp620;
			float fTemp621 = (0.5f * fVec136[1]);
			float fTemp622 = (0.5f * fVec136[0]);
			float fTemp623 = (1 + fTemp622);
			float fTemp624 = (fTemp623 - (fTemp621 + floorf((fTemp623 - fTemp621))));
			float fTemp625 = (0.5f * (1.0f + fVec136[0]));
			int iTemp626 = ((int((fTemp621 > fTemp622)))?1:((int(((fTemp625 - floorf(fTemp625)) < fTemp624)))?2:0));
			fRec361[0] = square_blep_x(iTemp626, ((int((fTemp622 < 0.5f)))?1.0f:-1.0f), fTemp622, fTemp624);
			float 	fRec362 = square_blep_prev(iTemp626, fRec361[1], fTemp621, fTemp624);
			...
			float fTemp627 = (iRec370[0] + fTemp17);
			fVec137[0] = fTemp627;
			float fTemp628 = (0.5f * fVec137[0]);
			float fTemp629 = (0.5f * fVec137[1]);
			iRec371[0] = ((int(((fTemp628 - fTemp629) < 0)))?(1 - iRec371[1]):iRec371[1]);
			float fTemp630 = (iRec371[0] + fTemp628);
			fVec138[0] = fTemp630;
			float fTemp631 = (0.5f * fVec138[1]);
			float fTemp632 = (0.5f * fVec138[0]);
			float fTemp633 = (1 + fTemp632);
			float fTemp634 = (fTemp633 - (fTemp631 + floorf((fTemp633 - fTemp631))));
			float fTemp635 = (0.5f * (1.0f + fVec138[0]));
			int iTemp636 = ((int((fTemp631 > fTemp632)))?1:((int(((fTemp635 - floorf(fTemp635)) < fTemp634)))?2:0));
			fRec368[0] = square_blep_x(iTemp636, ((int((fTemp632 < 0.5f)))?1.0f:-1.0f), fTemp632, fTemp634);
			float 	fRec369 = square_blep_prev(iTemp636, fRec368[1], fTemp631, fTemp634);
			...
			float fTemp637 = (iRec376[0] + fTemp38);
			fVec139[0] = fTemp637;
			float fTemp638 = (0.5f * fVec139[0]);
			float fTemp639 = (0.5f * fVec139[1]);
			iRec377[0] = ((int(((fTemp638 - fTemp639) < 0)))?(1 - iRec377[1]):iRec377[1]);
			float fTemp640 = (iRec377[0] + fTemp638);
			fVec140[0] = fTemp640;
			float fTemp641 = (0.5f * fVec140[1]);
			float fTemp642 = (0.5f * fVec140[0]);
			float fTemp643 = (1 + fTemp642);
			float fTemp644 = (fTemp643 - (fTemp641 + floorf((fTemp643 - fTemp641))));
			float fTemp645 = (0.5f * (1.0f + fVec140[0]));
			int iTemp646 = ((int((fTemp641 > fTemp642)))?1:((int(((fTemp645 - floorf(fTemp645)) < fTemp644)))?2:0));
			fRec374[0] = square_blep_x(iTemp646, ((int((fTemp642 < 0.5f)))?1.0f:-1.0f), fTemp642, fTemp644);
			float 	fRec375 = square_blep_prev(iTemp646, fRec374[1], fTemp641, fTemp644);
			...
			float fTemp647 = (iRec382[0] + fTemp59);
			fVec141[0] = fTemp647;
			float fTemp648 = (0.5f * fVec141[0]);
			float fTemp649 = (0.5f * fVec141[1]);
			iRec383[0] = ((int(((fTemp648 - fTemp649) < 0)))?(1 - iRec383[1]):iRec383[1]);
			float fTemp650 = (iRec383[0] + fTemp648);
			fVec142[0] = fTemp650;
			float fTemp651 = (0.5f * fVec142[1]);
			float fTemp652 = (0.5f * fVec142[0]);
			float fTemp653 = (1 + fTemp652);
			float fTemp654 = (fTemp653 - (fTemp651 + floorf((fTemp653 - fTemp651))));
			float fTemp655 = (0.5f * (1.0f + fVec142[0]));
			int iTemp656 = ((int((fTemp651 > fTemp652)))?1:((int(((fTemp655 - floorf(fTemp655)) < fTemp654)))?2:0));
			fRec380[0] = square_blep_x(iTemp656, ((int((fTemp652 < 0.5f)))?1.0f:-1.0f), fTemp652, fTemp654);
			float 	fRec381 = square_blep_prev(iTemp656, fRec380[1], fTemp651, fTemp654);
			...
			float fTemp657 = (iRec388[0] + fTemp80);
			fVec143[0] = fTemp657;
			float fTemp658 = (0.5f * fVec143[0]);
			float fTemp659 = (0.5f * fVec143[1]);
			iRec389[0] = ((int(((fTemp658 - fTemp659) < 0)))?(1 - iRec389[1]):iRec389[1]);
			float fTemp660 = (iRec389[0] + fTemp658);
			fVec144[0] = fTemp660;
			float fTemp661 = (0.5f * fVec144[1]);
			float fTemp662 = (0.5f * fVec144[0]);
			float fTemp663 = (1 + fTemp662);
			float fTemp664 = (fTemp663 - (fTemp661 + floorf((fTemp663 - fTemp661))));
			float fTemp665 = (0.5f * (1.0f + fVec144[0]));
			int iTemp666 = ((int((fTemp661 > fTemp662)))?1:((int(((fTemp665 - floorf(fTemp665)) < fTemp664)))?2:0));
			fRec386[0] = square_blep_x(iTemp666, ((int((fTemp662 < 0.5f)))?1.0f:-1.0f), fTemp662, fTemp664);
			float 	fRec387 = square_blep_prev(iTemp666, fRec386[1], fTemp661, fTemp664);
			...
			float fTemp667 = (iRec394[0] + fTemp101);
			fVec145[0] = fTemp667;
			float fTemp668 = (0.5f * fVec145[0]);
			float fTemp669 = (0.5f * fVec145[1]);
			iRec395[0] = ((int(((fTemp668 - fTemp669) < 0)))?(1 - iRec395[1]):iRec395[1]);
			float fTemp670 = (iRec395[0] + fTemp668);
			fVec146[0] = fTemp670;
			float fTemp671 = (0.5f * fVec146[1]);
			float fTemp672 = (0.5f * fVec146[0]);
			float fTemp673 = (1 + fTemp672);
			float fTemp674 = (fTemp673 - (fTemp671 + floorf((fTemp673 - fTemp671))));
			float fTemp675 = (0.5f * (1.0f + fVec146[0]));
			int iTemp676 = ((int((fTemp671 > fTemp672)))?1:((int(((fTemp675 - floorf(fTemp675)) < fTemp674)))?2:0));
			fRec392[0] = square_blep_x(iTemp676, ((int((fTemp672 < 0.5f)))?1.0f:-1.0f), fTemp672, fTemp674);
			float 	fRec393 = square_blep_prev(iTemp676, fRec392[1], fTemp671, fTemp674);
			fRec391[0] = (fRec391[1] + (fConst22 * (fRec393 - fRec391[1])));
			fRec390[0] = (fConst21 * ((fRec391[0] - fRec391[1]) + fRec390[1]));
			float fTemp677 = (1 + fTemp540);
			float fTemp678 = (fTemp677 - (fTemp541 + floorf((fTemp677 - fTemp541))));
			float fTemp679 = (0.5f * (1.0f + fVec117[0]));
			int iTemp680 = ((int((fTemp541 > fTemp540)))?1:((int(((fTemp679 - floorf(fTemp679)) < fTemp678)))?2:0));
			fRec398[0] = square_blep_x(iTemp680, ((int((fTemp540 < 0.5f)))?1.0f:-1.0f), fTemp540, fTemp678);
			float 	fRec399 = square_blep_prev(iTemp680, fRec398[1], fTemp541, fTemp678);
			fRec397[0] = (fRec397[1] + (fConst22 * (fRec399 - fRec397[1])));
			fRec396[0] = (fConst23 * ((fRec397[0] - fRec397[1]) + fRec396[1]));
			float fTemp681 = (1 + fTemp553);
			float fTemp682 = (fTemp681 - (fTemp554 + floorf((fTemp681 - fTemp554))));
			float fTemp683 = (0.5f * (1.0f + fVec120[0]));
			int iTemp684 = ((int((fTemp554 > fTemp553)))?1:((int(((fTemp683 - floorf(fTemp683)) < fTemp682)))?2:0));
			fRec402[0] = square_blep_x(iTemp684, ((int((fTemp553 < 0.5f)))?1.0f:-1.0f), fTemp553, fTemp682);
			float 	fRec403 = square_blep_prev(iTemp684, fRec402[1], fTemp554, fTemp682);
			fRec401[0] = (fRec401[1] + (fConst22 * (fRec403 - fRec401[1])));
			fRec400[0] = (fConst23 * ((fRec401[0] - fRec401[1]) + fRec400[1]));
			float fTemp685 = (1 + fTemp566);
			float fTemp686 = (fTemp685 - (fTemp567 + floorf((fTemp685 - fTemp567))));
			float fTemp687 = (0.5f * (1.0f + fVec123[0]));
			int iTemp688 = ((int((fTemp567 > fTemp566)))?1:((int(((fTemp687 - floorf(fTemp687)) < fTemp686)))?2:0));
			fRec406[0] = square_blep_x(iTemp688, ((int((fTemp566 < 0.5f)))?1.0f:-1.0f), fTemp566, fTemp686);
			float 	fRec407 = square_blep_prev(iTemp688, fRec406[1], fTemp567, fTemp686);
			fRec405[0] = (fRec405[1] + (fConst22 * (fRec407 - fRec405[1])));
			fRec404[0] = (fConst23 * ((fRec405[0] - fRec405[1]) + fRec404[1]));
			float fTemp689 = (1 + fTemp579);
			float fTemp690 = (fTemp689 - (fTemp580 + floorf((fTemp689 - fTemp580))));
			float fTemp691 = (0.5f * (1.0f + fVec126[0]));
			int iTemp692 = ((int((fTemp580 > fTemp579)))?1:((int(((fTemp691 - floorf(fTemp691)) < fTemp690)))?2:0));
			fRec410[0] = square_blep_x(iTemp692, ((int((fTemp579 < 0.5f)))?1.0f:-1.0f), fTemp579, fTemp690);
			float 	fRec411 = square_blep_prev(iTemp692, fRec410[1], fTemp580, fTemp690);
			fRec409[0] = (fRec409[1] + (fConst22 * (fRec411 - fRec409[1])));
			fRec408[0] = (fConst23 * ((fRec409[0] - fRec409[1]) + fRec408[1]));
			float fTemp693 = (1 + fTemp592);
			float fTemp694 = (fTemp693 - (fTemp593 + floorf((fTemp693 - fTemp593))));
			float fTemp695 = (0.5f * (1.0f + fVec129[0]));
			int iTemp696 = ((int((fTemp593 > fTemp592)))?1:((int(((fTemp695 - floorf(fTemp695)) < fTemp694)))?2:0));
			fRec414[0] = square_blep_x(iTemp696, ((int((fTemp592 < 0.5f)))?1.0f:-1.0f), fTemp592, fTemp694);
			float 	fRec415 = square_blep_prev(iTemp696, fRec414[1], fTemp593, fTemp694);
			fRec413[0] = (fRec413[1] + (fConst24 * (fRec415 - fRec413[1])));
			fRec412[0] = (fConst23 * ((fRec413[0] - fRec413[1]) + fRec412[1]));
			float fTemp697 = ((fRec412[0] * fTemp252) + ((fRec408[0] * fTemp247) + ((fRec404[0] * fTemp242) + ((fRec400[0] * fTemp237) + ((fRec396[0] * fTemp232) + ((fRec390[0] * fTemp214) + ((fRec384[0] * fTemp196) + ((fRec378[0] * fTemp178) + ((fRec372[0] * fTemp160) + ((fRec366[0] * fTemp142) + ((fRec359[0] * fTemp124) + ((fRec352[0] * fTemp106) + ((fRec345[0] * fTemp85) + ((fRec338[0] * fTemp64) + ((fRec331[0] * fTemp43) + ((fRec324[0] * fTemp22) + (fRec317[0] * fTemp0)))))))))))))))));
			float fTemp698 = (1 + fTemp605);
			float fTemp699 = (fTemp698 - (fTemp606 + floorf((fTemp698 - fTemp606))));
			float fTemp700 = (0.5f * (1.0f + fVec132[0]));
			int iTemp701 = ((int((fTemp606 > fTemp605)))?1:((int(((fTemp700 - floorf(fTemp700)) < fTemp699)))?2:0));
			fRec418[0] = square_blep_x(iTemp701, ((int((fTemp605 < 0.5f)))?1.0f:-1.0f), fTemp605, fTemp699);
			float 	fRec419 = square_blep_prev(iTemp701, fRec418[1], fTemp606, fTemp699);
			fRec417[0] = (fRec417[1] + (fConst24 * (fRec419 - fRec417[1])));
			fRec416[0] = (fConst23 * ((fRec417[0] - fRec417[1]) + fRec416[1]));
			float fTemp702 = (1 + fTemp618);
			float fTemp703 = (fTemp702 - (fTemp619 + floorf((fTemp702 - fTemp619))));
			float fTemp704 = (0.5f * (1.0f + fVec135[0]));
			int iTemp705 = ((int((fTemp619 > fTemp618)))?1:((int(((fTemp704 - floorf(fTemp704)) < fTemp703)))?2:0));
			fRec422[0] = square_blep_x(iTemp705, ((int((fTemp618 < 0.5f)))?1.0f:-1.0f), fTemp618, fTemp703);
			float 	fRec423 = square_blep_prev(iTemp705, fRec422[1], fTemp619, fTemp703);
			fRec421[0] = (fRec421[1] + (fConst24 * (fRec423 - fRec421[1])));
			fRec420[0] = (fConst23 * ((fRec421[0] - fRec421[1]) + fRec420[1]));
			float fTemp706 = (1 + fTemp628);
			float fTemp707 = (fTemp706 - (fTemp629 + floorf((fTemp706 - fTemp629))));
			float fTemp708 = (0.5f * (1.0f + fVec137[0]));
			int iTemp709 = ((int((fTemp629 > fTemp628)))?1:((int(((fTemp708 - floorf(fTemp708)) < fTemp707)))?2:0));
			fRec426[0] = square_blep_x(iTemp709, ((int((fTemp628 < 0.5f)))?1.0f:-1.0f), fTemp628, fTemp707);
			float 	fRec427 = square_blep_prev(iTemp709, fRec426[1], fTemp629, fTemp707);
			fRec425[0] = (fRec425[1] + (fConst24 * (fRec427 - fRec425[1])));
			fRec424[0] = (fConst23 * ((fRec425[0] - fRec425[1]) + fRec424[1]));
			float fTemp710 = (1 + fTemp638);
			float fTemp711 = (fTemp710 - (fTemp639 + floorf((fTemp710 - fTemp639))));
			float fTemp712 = (0.5f * (1.0f + fVec139[0]));
			int iTemp713 = ((int((fTemp639 > fTemp638)))?1:((int(((fTemp712 - floorf(fTemp712)) < fTemp711)))?2:0));
			fRec430[0] = square_blep_x(iTemp713, ((int((fTemp638 < 0.5f)))?1.0f:-1.0f), fTemp638, fTemp711);
			float 	fRec431 = square_blep_prev(iTemp713, fRec430[1], fTemp639, fTemp711);
			fRec429[0] = (fRec429[1] + (fConst25 * (fRec431 - fRec429[1])));
			fRec428[0] = (fConst23 * ((fRec429[0] - fRec429[1]) + fRec428[1]));
			float fTemp714 = (1 + fTemp648);
			float fTemp715 = (fTemp714 - (fTemp649 + floorf((fTemp714 - fTemp649))));
			float fTemp716 = (0.5f * (1.0f + fVec141[0]));
			int iTemp717 = ((int((fTemp649 > fTemp648)))?1:((int(((fTemp716 - floorf(fTemp716)) < fTemp715)))?2:0));
			fRec434[0] = square_blep_x(iTemp717, ((int((fTemp648 < 0.5f)))?1.0f:-1.0f), fTemp648, fTemp715);
			float 	fRec435 = square_blep_prev(iTemp717, fRec434[1], fTemp649, fTemp715);
			fRec433[0] = (fRec433[1] + (fConst25 * (fRec435 - fRec433[1])));
			fRec432[0] = (fConst23 * ((fRec433[0] - fRec433[1]) + fRec432[1]));
			float fTemp718 = (1 + fTemp658);
			float fTemp719 = (fTemp718 - (fTemp659 + floorf((fTemp718 - fTemp659))));
			float fTemp720 = (0.5f * (1.0f + fVec143[0]));
			int iTemp721 = ((int((fTemp659 > fTemp658)))?1:((int(((fTemp720 - floorf(fTemp720)) < fTemp719)))?2:0));
			fRec438[0] = square_blep_x(iTemp721, ((int((fTemp658 < 0.5f)))?1.0f:-1.0f), fTemp658, fTemp719);
			float 	fRec439 = square_blep_prev(iTemp721, fRec438[1], fTemp659, fTemp719);
			fRec437[0] = (fRec437[1] + (fConst25 * (fRec439 - fRec437[1])));
			fRec436[0] = (fConst23 * ((fRec437[0] - fRec437[1]) + fRec436[1]));
			float fTemp722 = (1 + fTemp668);
			float fTemp723 = (fTemp722 - (fTemp669 + floorf((fTemp722 - fTemp669))));
			float fTemp724 = (0.5f * (1.0f + fVec145[0]));
			int iTemp725 = ((int((fTemp669 > fTemp668)))?1:((int(((fTemp724 - floorf(fTemp724)) < fTemp723)))?2:0));
			fRec442[0] = square_blep_x(iTemp725, ((int((fTemp668 < 0.5f)))?1.0f:-1.0f), fTemp668, fTemp723);
			float 	fRec443 = square_blep_prev(iTemp725, fRec442[1], fTemp669, fTemp723);
			fRec441[0] = (fRec441[1] + (fConst25 * (fRec443 - fRec441[1])));
			fRec440[0] = (fConst23 * ((fRec441[0] - fRec441[1]) + fRec440[1]));
			float fTemp726 = (1 + fTemp537);
			float fTemp727 = (fTemp726 - (fTemp538 + floorf((fTemp726 - fTemp538))));
			float fTemp728 = (0.5f * (1.0f + fVec116[0]));
			int iTemp729 = ((int((fTemp538 > fTemp537)))?1:((int(((fTemp728 - floorf(fTemp728)) < fTemp727)))?2:0));
			fRec446[0] = square_blep_x(iTemp729, ((int((fTemp537 < 0.5f)))?1.0f:-1.0f), fTemp537, fTemp727);
			float 	fRec447 = square_blep_prev(iTemp729, fRec446[1], fTemp538, fTemp727);
			fRec445[0] = (fRec445[1] + (fConst25 * (fRec447 - fRec445[1])));
			fRec444[0] = (fConst4 * ((fRec445[0] - fRec445[1]) + fRec444[1]));
			float fTemp730 = (1 + fTemp550);
			float fTemp731 = (fTemp730 - (fTemp551 + floorf((fTemp730 - fTemp551))));
			float fTemp732 = (0.5f * (1.0f + fVec119[0]));
			int iTemp733 = ((int((fTemp551 > fTemp550)))?1:((int(((fTemp732 - floorf(fTemp732)) < fTemp731)))?2:0));
			fRec450[0] = square_blep_x(iTemp733, ((int((fTemp550 < 0.5f)))?1.0f:-1.0f), fTemp550, fTemp731);
			float 	fRec451 = square_blep_prev(iTemp733, fRec450[1], fTemp551, fTemp731);
			fRec449[0] = (fRec449[1] + (fConst25 * (fRec451 - fRec449[1])));
			fRec448[0] = (fConst4 * ((fRec449[0] - fRec449[1]) + fRec448[1]));
			float fTemp734 = (1 + fTemp563);
			float fTemp735 = (fTemp734 - (fTemp564 + floorf((fTemp734 - fTemp564))));
			float fTemp736 = (0.5f * (1.0f + fVec122[0]));
			int iTemp737 = ((int((fTemp564 > fTemp563)))?1:((int(((fTemp736 - floorf(fTemp736)) < fTemp735)))?2:0));
			fRec454[0] = square_blep_x(iTemp737, ((int((fTemp563 < 0.5f)))?1.0f:-1.0f), fTemp563, fTemp735);
			float 	fRec455 = square_blep_prev(iTemp737, fRec454[1], fTemp564, fTemp735);
			fRec453[0] = (fRec453[1] + (fConst25 * (fRec455 - fRec453[1])));
			fRec452[0] = (fConst4 * ((fRec453[0] - fRec453[1]) + fRec452[1]));
			float fTemp738 = (1 + fTemp576);
			float fTemp739 = (fTemp738 - (fTemp577 + floorf((fTemp738 - fTemp577))));
			float fTemp740 = (0.5f * (1.0f + fVec125[0]));
			int iTemp741 = ((int((fTemp577 > fTemp576)))?1:((int(((fTemp740 - floorf(fTemp740)) < fTemp739)))?2:0));
			fRec458[0] = square_blep_x(iTemp741, ((int((fTemp576 < 0.5f)))?1.0f:-1.0f), fTemp576, fTemp739);
			float 	fRec459 = square_blep_prev(iTemp741, fRec458[1], fTemp577, fTemp739);
			fRec457[0] = (fRec457[1] + (fConst25 * (fRec459 - fRec457[1])));
			fRec456[0] = (fConst4 * ((fRec457[0] - fRec457[1]) + fRec456[1]));
			float fTemp742 = (1 + fTemp589);
			float fTemp743 = (fTemp742 - (fTemp590 + floorf((fTemp742 - fTemp590))));
			float fTemp744 = (0.5f * (1.0f + fVec128[0]));
			int iTemp745 = ((int((fTemp590 > fTemp589)))?1:((int(((fTemp744 - floorf(fTemp744)) < fTemp743)))?2:0));
			fRec462[0] = square_blep_x(iTemp745, ((int((fTemp589 < 0.5f)))?1.0f:-1.0f), fTemp589, fTemp743);
			float 	fRec463 = square_blep_prev(iTemp745, fRec462[1], fTemp590, fTemp743);
			fRec461[0] = (fRec461[1] + (fConst2 * (fRec463 - fRec461[1])));
			fRec460[0] = (fConst4 * ((fRec461[0] - fRec461[1]) + fRec460[1]));
			float fTemp746 = (1 + fTemp602);
			float fTemp747 = (fTemp746 - (fTemp603 + floorf((fTemp746 - fTemp603))));
			float fTemp748 = (0.5f * (1.0f + fVec131[0]));
			int iTemp749 = ((int((fTemp603 > fTemp602)))?1:((int(((fTemp748 - floorf(fTemp748)) < fTemp747)))?2:0));
			fRec466[0] = square_blep_x(iTemp749, ((int((fTemp602 < 0.5f)))?1.0f:-1.0f), fTemp602, fTemp747);
			float 	fRec467 = square_blep_prev(iTemp749, fRec466[1], fTemp603, fTemp747);
			fRec465[0] = (fRec465[1] + (fConst2 * (fRec467 - fRec465[1])));
			fRec464[0] = (fConst4 * ((fRec465[0] - fRec465[1]) + fRec464[1]));
			float fTemp750 = (1 + fTemp615);
			float fTemp751 = (fTemp750 - (fTemp616 + floorf((fTemp750 - fTemp616))));
			float fTemp752 = (0.5f * (1.0f + fVec134[0]));
			int iTemp753 = ((int((fTemp616 > fTemp615)))?1:((int(((fTemp752 - floorf(fTemp752)) < fTemp751)))?2:0));
			fRec470[0] = square_blep_x(iTemp753, ((int((fTemp615 < 0.5f)))?1.0f:-1.0f), fTemp615, fTemp751);
			float 	fRec471 = square_blep_prev(iTemp753, fRec470[1], fTemp616, fTemp751);
			fRec469[0] = (fRec469[1] + (fConst2 * (fRec471 - fRec469[1])));
			fRec468[0] = (fConst4 * ((fRec469[0] - fRec469[1]) + fRec468[1]));
			float fTemp754 = (0.41975f * ((fRec183[0] * fTemp465) + ((fRec179[0] * fTemp461) + ((fRec175[0] * fTemp457) + ((fRec171[0] * fTemp453) + ((fRec167[0] * fTemp449) + ((fRec163[0] * fTemp445) + ((fRec159[0] * fTemp441) + ((fRec155[0] * fTemp437) + ((fRec151[0] * fTemp432) + ((fRec147[0] * fTemp427) + ((fRec143[0] * fTemp422) + ((fRec139[0] * fTemp417) + ((fRec135[0] * fTemp412) + ((fRec131[0] * fTemp407) + ((fRec127[0] * fTemp402) + ((fRec123[0] * fTemp397) + ((fRec119[0] * fTemp392) + ((fRec115[0] * fTemp387) + ((fRec106[0] * fTemp382) + ((fRec97[0] * fTemp377) + ((fRec88[0] * fTemp372) + ((fRec79[0] * fTemp367) + ((fRec70[0] * fTemp362) + ((fRec61[0] * fTemp357) + ((fRec52[0] * fTemp352) + ((fRec42[0] * fTemp347) + ((fRec32[0] * fTemp342) + ((fRec22[0] * fTemp337) + ((fRec12[0] * fTemp332) + ((fRec1[0] * fTemp327) + ((fRec468[0] * fTemp322) + ((fRec464[0] * fTemp317) + ((fRec460[0] * fTemp312) + ((fRec456[0] * fTemp307) + ((fRec452[0] * fTemp302) + ((fRec448[0] * fTemp297) + ((fRec444[0] * fTemp292) + ((fRec440[0] * fTemp287) + ((fRec436[0] * fTemp282) + ((fRec432[0] * fTemp277) + ((fRec428[0] * fTemp272) + ((fRec424[0] * fTemp267) + ((fRec420[0] * fTemp262) + ((fRec416[0] * fTemp257) + (fSlow36 * fTemp697))))))))))))))))))))))))))))))))))))))))))))));
			...
			iRec474[0] = ((iVec148[IOTA&4095] + iRec474[1]) - iVec148[(IOTA-iConst28)&4095]);
			float fTemp758 = log10f(sqrtf((fConst29 * float(iRec474[0]))));
			fVec149[0] = fTemp758;
			...
			fVec150[0] = fTemp761;
			float fTemp762 = (fSlow83 * (max(fSlow82, (0.25f * (fVec150[4] + (fVec150[3] + (fVec150[0] + fVec150[2]))))) * ((0.5f * fTemp756) + (0.25f * ((fTemp535 + fTemp469) + (0.008f * fTemp477))))));
			...
			output1[i] = (FAUSTFLOAT)(fTemp785 * (fTemp784 + (fTemp762 + fTemp781)));
			output2[i] = (FAUSTFLOAT)(fTemp765 * fTemp785);
			// post processing
			fRec498[1] = fRec498[0];
			fRec497[1] = fRec497[0];
			fVec161[1] = fVec161[0];
			...
			fRec299[1] = fRec299[0];
			fRec298[1] = fRec298[0];
			for (int i=3; i>0; i--) fVec112[i] = fVec112[i-1];
			fRec294[1] = fRec294[0];
			fRec296[1] = fRec296[0];
			fRec295[1] = fRec295[0];
			...
			fRec293[1] = fRec293[0];
			fRec292[1] = fRec292[0];
			for (int i=3; i>0; i--) fVec110[i] = fVec110[i-1];
			fRec288[1] = fRec288[0];
			fRec290[1] = fRec290[0];
			fRec289[1] = fRec289[0];
			...
			fRec287[1] = fRec287[0];
			fRec286[1] = fRec286[0];
			for (int i=3; i>0; i--) fVec108[i] = fVec108[i-1];
			fRec282[1] = fRec282[0];
			fRec284[1] = fRec284[0];
			fRec283[1] = fRec283[0];
			...
			fRec281[1] = fRec281[0];
			fRec280[1] = fRec280[0];
			for (int i=3; i>0; i--) fVec106[i] = fVec106[i-1];
			fRec275[1] = fRec275[0];
			fRec276[1] = fRec276[0];
			fRec277[1] = fRec277[0];
			...
			fRec272[1] = fRec272[0];
			fRec273[1] = fRec273[0];
			for (int i=3; i>0; i--) fVec104[i] = fVec104[i-1];
			fRec267[1] = fRec267[0];
			fRec268[1] = fRec268[0];
			fRec269[1] = fRec269[0];
			...
			fRec264[1] = fRec264[0];
			fRec265[1] = fRec265[0];
			for (int i=3; i>0; i--) fVec102[i] = fVec102[i-1];
			fRec259[1] = fRec259[0];
			fRec260[1] = fRec260[0];
			fRec261[1] = fRec261[0];
			...
			fRec256[1] = fRec256[0];
			fRec257[1] = fRec257[0];
			for (int i=3; i>0; i--) fVec100[i] = fVec100[i-1];
			fRec251[1] = fRec251[0];
			fRec252[1] = fRec252[0];
			fRec253[1] = fRec253[0];
			...
			fRec248[1] = fRec248[0];
			fRec249[1] = fRec249[0];
			for (int i=3; i>0; i--) fVec98[i] = fVec98[i-1];
			fRec243[1] = fRec243[0];
			fRec244[1] = fRec244[0];
			fRec245[1] = fRec245[0];
			...
			fRec240[1] = fRec240[0];
			fRec241[1] = fRec241[0];
			for (int i=3; i>0; i--) fVec96[i] = fVec96[i-1];
			fRec235[1] = fRec235[0];
			fRec236[1] = fRec236[0];
			fRec237[1] = fRec237[0];
			...
			fRec232[1] = fRec232[0];
			fRec233[1] = fRec233[0];
			for (int i=3; i>0; i--) fVec94[i] = fVec94[i-1];
			fRec227[1] = fRec227[0];
			fRec228[1] = fRec228[0];
			fRec229[1] = fRec229[0];
			...
			fRec224[1] = fRec224[0];
			fRec225[1] = fRec225[0];
			for (int i=3; i>0; i--) fVec92[i] = fVec92[i-1];
			fRec219[1] = fRec219[0];
			fRec220[1] = fRec220[0];
			fRec221[1] = fRec221[0];
			...
			fRec216[1] = fRec216[0];
			fRec217[1] = fRec217[0];
			for (int i=3; i>0; i--) fVec90[i] = fVec90[i-1];
			fRec211[1] = fRec211[0];
			fRec212[1] = fRec212[0];
			fRec213[1] = fRec213[0];
			...
			fRec208[1] = fRec208[0];
			fRec209[1] = fRec209[0];
			for (int i=3; i>0; i--) fVec88[i] = fVec88[i-1];
			fRec203[1] = fRec203[0];
			fRec204[1] = fRec204[0];
			fRec205[1] = fRec205[0];
			...
			fRec200[1] = fRec200[0];
			fRec201[1] = fRec201[0];
			for (int i=3; i>0; i--) fVec86[i] = fVec86[i-1];
			fRec195[1] = fRec195[0];
			fRec196[1] = fRec196[0];
			fRec197[1] = fRec197[0];
			...
			fRec192[1] = fRec192[0];
			fRec193[1] = fRec193[0];
			for (int i=3; i>0; i--) fVec84[i] = fVec84[i-1];
			fRec187[1] = fRec187[0];
			fRec188[1] = fRec188[0];
			fRec189[1] = fRec189[0];
			...
			fRec184[1] = fRec184[0];
			fRec185[1] = fRec185[0];
			for (int i=3; i>0; i--) fVec82[i] = fVec82[i-1];
			fRec179[1] = fRec179[0];
			fRec180[1] = fRec180[0];
			fRec181[1] = fRec181[0];
			...
			fRec176[1] = fRec176[0];
			fRec177[1] = fRec177[0];
			for (int i=3; i>0; i--) fVec80[i] = fVec80[i-1];
			fRec171[1] = fRec171[0];
			fRec172[1] = fRec172[0];
			fRec173[1] = fRec173[0];
			...
			fRec168[1] = fRec168[0];
			fRec169[1] = fRec169[0];
			for (int i=3; i>0; i--) fVec78[i] = fVec78[i-1];
			fRec163[1] = fRec163[0];
			fRec164[1] = fRec164[0];
			fRec165[1] = fRec165[0];
			...
			fRec160[1] = fRec160[0];
			fRec161[1] = fRec161[0];
			for (int i=3; i>0; i--) fVec76[i] = fVec76[i-1];
			fRec155[1] = fRec155[0];
			fRec156[1] = fRec156[0];
			fRec157[1] = fRec157[0];
			...
			fRec152[1] = fRec152[0];
			fRec153[1] = fRec153[0];
			for (int i=3; i>0; i--) fVec74[i] = fVec74[i-1];
			fRec147[1] = fRec147[0];
			fRec148[1] = fRec148[0];
			fRec149[1] = fRec149[0];
			...
			fRec144[1] = fRec144[0];
			fRec145[1] = fRec145[0];
			for (int i=3; i>0; i--) fVec72[i] = fVec72[i-1];
			fRec139[1] = fRec139[0];
			fRec140[1] = fRec140[0];
			fRec141[1] = fRec141[0];
			...
			fRec136[1] = fRec136[0];
			fRec137[1] = fRec137[0];
			for (int i=3; i>0; i--) fVec70[i] = fVec70[i-1];
			fRec131[1] = fRec131[0];
			fRec132[1] = fRec132[0];
			fRec133[1] = fRec133[0];
			...
			fRec128[1] = fRec128[0];
			fRec129[1] = fRec129[0];
			for (int i=3; i>0; i--) fVec68[i] = fVec68[i-1];
			fRec123[1] = fRec123[0];
			fRec124[1] = fRec124[0];
			fRec125[1] = fRec125[0];
			...
			fRec120[1] = fRec120[0];
			fRec121[1] = fRec121[0];
			for (int i=3; i>0; i--) fVec66[i] = fVec66[i-1];
			fRec115[1] = fRec115[0];
			fRec116[1] = fRec116[0];
			fRec117[1] = fRec117[0];
			...
			iRec110[1] = iRec110[0];
			fRec111[1] = fRec111[0];
			for (int i=3; i>0; i--) fVec60[i] = fVec60[i-1];
			fRec97[1] = fRec97[0];
			fRec98[1] = fRec98[0];
			fRec99[1] = fRec99[0];
			fVec59[1] = fVec59[0];
			...
			iRec92[1] = iRec92[0];
			fRec93[1] = fRec93[0];
			for (int i=3; i>0; i--) fVec50[i] = fVec50[i-1];
			fRec79[1] = fRec79[0];
			fRec80[1] = fRec80[0];
			fRec81[1] = fRec81[0];
			fVec49[1] = fVec49[0];
			...
			iRec83[1] = iRec83[0];
			fRec84[1] = fRec84[0];
			for (int i=3; i>0; i--) fVec45[i] = fVec45[i-1];
			fRec70[1] = fRec70[0];
			fRec71[1] = fRec71[0];
			fRec72[1] = fRec72[0];
			fVec44[1] = fVec44[0];
			...
			iRec74[1] = iRec74[0];
			fRec75[1] = fRec75[0];
			for (int i=3; i>0; i--) fVec40[i] = fVec40[i-1];
			fRec61[1] = fRec61[0];
			fRec62[1] = fRec62[0];
			fRec63[1] = fRec63[0];
			fVec39[1] = fVec39[0];
			...
			iRec56[1] = iRec56[0];
			fRec57[1] = fRec57[0];
			for (int i=3; i>0; i--) fVec30[i] = fVec30[i-1];
			fRec42[1] = fRec42[0];
			fRec43[1] = fRec43[0];
			fRec44[1] = fRec44[0];
			fVec29[1] = fVec29[0];
			...
			iRec46[1] = iRec46[0];
			fRec47[1] = fRec47[0];
			for (int i=3; i>0; i--) fVec24[i] = fVec24[i-1];
			fRec32[1] = fRec32[0];
			fRec33[1] = fRec33[0];
			fRec34[1] = fRec34[0];
			fVec23[1] = fVec23[0];
			...
			iRec36[1] = iRec36[0];
			fRec37[1] = fRec37[0];
			for (int i=3; i>0; i--) fVec18[i] = fVec18[i-1];
			fRec22[1] = fRec22[0];
			fRec23[1] = fRec23[0];
			fRec24[1] = fRec24[0];
			fVec17[1] = fVec17[0];
			...
			iRec26[1] = iRec26[0];
			fRec27[1] = fRec27[0];
			for (int i=3; i>0; i--) fVec12[i] = fVec12[i-1];
			fRec12[1] = fRec12[0];
			fRec13[1] = fRec13[0];
			fRec14[1] = fRec14[0];
			fVec11[1] = fVec11[0];
			...
			iRec16[1] = iRec16[0];
			fRec17[1] = fRec17[0];
			for (int i=3; i>0; i--) fVec6[i] = fVec6[i-1];
			fRec1[1] = fRec1[0];
			fRec2[1] = fRec2[0];
			fRec3[1] = fRec3[0];
			fVec5[1] = fVec5[0];
